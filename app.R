...
#### downloaded from 1. https://www.kaggle.com/datasets/nadyafed/melbourne-airbnb-2020
#### downloaded from 2. http://insideairbnb.com/get-the-data/ 
...
#due to issues in loading the datasets to shinyapps.io, 
#the 2 datasets commented below are merged locally, and the 'merged' data is loaded back into rshiny
#see 'listings_merged' below for the merged data
#the section of code leading to the creation of the 'listings_merged' data is commented below

#### Creation of 'listing_merged' data ####
...
#### end creation of 'listings_merged' data ####
...
ui <- dashboardPage(
  ...
  dashboardBody(tags$style(
    ...
    fluidPage(
      ...
      fluidRow(box(width=50, height=50, title="Data References: ")),
      fluidRow(box(width=50, height=70, title="1: Melbourne Airbnb 2020, 
                   License: \'CC0: Public Domain\', Updated: 2020, 
                   url: https://www.kaggle.com/datasets/nadyafed/melbourne-airbnb-2020")),
      fluidRow(box(width=50, height=70, title="2: Inside Airbnb, Adding data to the debate, Melbourne, Victoria, Australia 
                   License: \'CC0: Public Domain\', Updated: 2020, 
